...
Public Class FishPackingReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sturgeon_Manager_v1._0.FishPackingReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFishPackingReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FishPackingReport = New FishPackingReport
        rpt.Site = Me.Site
        Return rpt
    End Function
