...
Public Class InventoryValueReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InventoryValueReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sturgeon_Manager_v1._0.InventoryValueReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventoryValueReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventoryValueReport = New InventoryValueReport
        rpt.Site = Me.Site
        Return rpt
    End Function
