...
Public Class FishInvoiceReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sturgeon_Manager_v1._0.FishInvoiceReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFishInvoiceReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FishInvoiceReport = New FishInvoiceReport
        rpt.Site = Me.Site
        Return rpt
    End Function
